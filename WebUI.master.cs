...
public partial class WebUI : System.Web.UI.MasterPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        KategoriSayi.DataSource = VT.KategoriSayi();
        KategoriSayi.DataBind();
        SonGonderilen.DataSource = VT.SonGonderilenMakele();
        SonGonderilen.DataBind();
        Pupuler.DataSource = VT.PopulerMakale();
        Pupuler.DataBind();
        SonYazilan.DataSource = VT.SonGonderilenMakele3();
        SonYazilan.DataBind();
        SonYorumlar.DataSource = VT.SonYorumlar();
