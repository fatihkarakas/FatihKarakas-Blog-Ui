<%@ Page Title="" Language="C#" MasterPageFile="~/WebUI.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="_Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:Repeater runat="server" ID="Makaleler">
        <ItemTemplate>
                            ...
                            <div class="col-xs-12  col-sm-8">
                                <div class="meta__info">
                                    ...
                                    <span class="meta__author">
                                        ...
                                        <a href="#">Fatih KARAKAŞ</a>  --> <a href="/Kategori/<%#Eval("CategoryId").ToString()%>">
										<%#Eval("KategoriAdi").ToString()%>
										</a> </span>
                                    <span class="meta__date"><span class="glyphicon glyphicon-calendar"></span>&nbsp; <%# Eval("CreateDate") %></span>
                                </div>
                            </div>
                            <div class="col-xs-12  col-sm-4">
                                <div class="meta__comments">
                                    <span><%#Eval("ViewCount") %> Kez Okundu</span>&nbsp;
                            <a href='Makale/<%# Eval("Title") %>/<%# Eval("Id") %>#disqus_thread'></a>
                                </div>
                            </div>
                        </div>
                    </div>
